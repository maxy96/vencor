...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/pagos.vue?vue&type=script&lang=js&":
/*!****************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/pagos.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPagos: function getPagos() {
      ...
      axios.get('/api/pagos').then(function (response) {
    ...
    // end getPagos
    addNewPago: function addNewPago() {
      var _this2 = this;
      ...
      axios.post('/api/pagos', {
        ...
        razon: this.newPago.newRazon //ticket: this.newPago.newTicket
    ...
    // end addNewPagos
    getTiposPagos: function getTiposPagos() {
      var _this3 = this;

      axios.get('/api/tipos-pagos').then(function (response) {
        _this3.tiposPagos = response.data;
      });
    } // end getTiposPagos
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/pagos.vue?vue&type=template&id=bca18682&":
/*!********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/pagos.vue?vue&type=template&id=bca18682& ***!
  \********************************************************************************************************************************************************************************************************/
                  ...
                  _c("div", { staticClass: "modal-body" }, [
                    _c("div", { staticClass: "form-group row" }, [
                      ...
                      _c(
                        ...
                        _vm._l(_vm.tiposPagos, function(tipoPago) {
                          return _c(
                            "div",
                            {
                              staticClass:
                            ...
                            [
                                ...
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: _vm.newPago.newTipoPago,
                                    expression: "newPago.newTipoPago"
                                  }
                                ],
                                staticClass: "custom-control-input",
                                attrs: {
                                  type: "radio",
                                  id: tipoPago.descripcion
                                },
                                domProps: {
                                  value: tipoPago.id_tipoPago,
                                  checked: _vm._q(
                                    _vm.newPago.newTipoPago,
                              ...
                              _c(
                                "label",
                                {
                                  ...
                                  attrs: { for: tipoPago.descripcion }
                                },
                                [_vm._v(_vm._s(tipoPago.descripcion))]
                              )
                            ]
                          )
                        }),
                        ...
                        _c(
                          ...
                          [
                            ...
                            _c("datetime", {
                              ...
                              model: {
                                value: _vm.newPago.newFecha,
                                callback: function($$v) {
                                  _vm.$set(_vm.newPago, "newFecha", $$v)
                                },
                                expression: "newPago.newFecha"
                              }
                            })
                          ],
                          1
                    ...
                    _c("div", { staticClass: "form-group row" }, [
                      ...
                      _c("div", { staticClass: "col-md-6" }, [
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.newPago.newImporte,
                              expression: "newPago.newImporte"
                            }
                          ],
                          ...
                          domProps: { value: _vm.newPago.newImporte },
                          on: {
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.newPago.newRazon,
                              expression: "newPago.newRazon"
                            }
                          ],
                          staticClass: "form-control",
                          attrs: { id: "newRazon", type: "text", required: "" },
                          domProps: { value: _vm.newPago.newRazon },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
      ...
      _c("table", { staticClass: "table table-hover table-striped" }, [
        ...
        _c(
          ...
          _vm._l(_vm.pagos, function(pago) {
            return _c("tr", [
              _c("td", [_vm._v(" " + _vm._s(pago.id_pago))]),
              _vm._v(" "),
              _c("td", [_vm._v(" " + _vm._s(pago.descripcion))]),
              _vm._v(" "),
              _c("td", [_vm._v(" " + _vm._s(pago.razon))]),
              _vm._v(" "),
              _c("td", [
                _vm._v(" " + _vm._s(_vm._f("fecha")(pago.fecha)) + "hs")
              ]),
              _vm._v(" "),
              _c("td", [_vm._v(" " + _vm._s(pago.dinero))]),
              _vm._v(" "),
              _c("td", [_vm._v(" " + _vm._s(pago.FechaPagado))]),
              _vm._v(" "),
              _c("td", [_vm._v(" " + _vm._s(pago.ticket))])
            ])
          }),
          0
        )
  ...
  function() {
    ...
    return _c("thead", { staticClass: "thead-bluelight" }, [
      _c("tr", [
        ...
        _vm._v(" "),
        _c("th", { attrs: { scope: "col" } }, [_vm._v("Razon")]),
        _vm._v(" "),
        _c("th", { attrs: { scope: "col" } }, [_vm._v("Fecha limite")]),
        _vm._v(" "),
        _c("th", { attrs: { scope: "col" } }, [_vm._v("Importe")]),
        _vm._v(" "),
        _c("th", { attrs: { scope: "col" } }, [_vm._v("Fecha pagado")]),
        _vm._v(" "),
        _c("th", { attrs: { scope: "col" } }, [_vm._v("Ticket")])
      ])
    ])
  }
]
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _pagos_vue_vue_type_template_id_bca18682___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./pagos.vue?vue&type=template&id=bca18682& */ "./resources/js/components/pagos.vue?vue&type=template&id=bca18682&");
/* harmony import */ var _pagos_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pagos.vue?vue&type=script&lang=js& */ "./resources/js/components/pagos.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _pagos_vue_vue_type_template_id_bca18682___WEBPACK_IMPORTED_MODULE_0__["render"],
  _pagos_vue_vue_type_template_id_bca18682___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/***/ "./resources/js/components/pagos.vue?vue&type=script&lang=js&":
/*!********************************************************************!*\
  !*** ./resources/js/components/pagos.vue?vue&type=script&lang=js& ***!
  \********************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/components/pagos.vue?vue&type=template&id=bca18682&":
/*!**************************************************************************!*\
  !*** ./resources/js/components/pagos.vue?vue&type=template&id=bca18682& ***!
  \**************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_pagos_vue_vue_type_template_id_bca18682___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./pagos.vue?vue&type=template&id=bca18682& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/pagos.vue?vue&type=template&id=bca18682&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_pagos_vue_vue_type_template_id_bca18682___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_pagos_vue_vue_type_template_id_bca18682___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
module.exports = __webpack_require__(/*! C:\laragon\www\vencor\resources\js\pagos.js */"./resources/js/pagos.js");
